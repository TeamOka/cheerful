        ...
        <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
            <div class="relative w-full max-w-7xl px-6 lg:px-8">
                ...
                <main class="mt-10 text-center">
                    <h2 class="text-4xl font-bold mb-4 mt-20 ">誰でも応援！誰もがクリエイター！</h2>
                    <p class="text-lg my-10">あなたのクリエイター活動を応援！個人クリエイター向けプラットフォーム「Cheerful」。</p>
                    <nav class="space-x-4">
                        @if (Route::has('login'))
                        <nav class=" flex flex-1 justify-center">
                            ...
                            <a
                                href="{{ url('/home') }}"
                                class="font-bold text-lg mx-6  bg-[#FF2D20] rounded-md px-6 py-3 text-white ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                                ホーム
                            </a>
                            @else
                            <a
